...
Summary: DB2 DBI module for Qore
Name: qore-db2-module
Version: 0.0.1
Release: 1%{dist}
License: LGPL
...
%description
DB2 DBI driver module for the Qore Programming Language. The DB2 driver is
...
mkdir -p $RPM_BUILD_ROOT/usr/share/doc/qore-db2-module
...
%defattr(-,root,root,-)
%{module_dir}
%doc COPYING README RELEASE-NOTES ChangeLog AUTHORS test/db-test.q docs/db2-module-doc.html

%changelog
* Tue Oct 23 2009 David Nichols <david_nichols@users.sourceforge.net>
- initial spec file for db2 module
